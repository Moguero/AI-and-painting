...
from dataset_utils.image_utils import decode_image, get_images_paths
...
def get_and_count_images_shapes(images_dir: Path):
    images_shapes = [decode_image(image_path).shape for image_path in get_images_paths(images_dir)]
