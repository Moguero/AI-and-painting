...
IMAGE_PATH = Path("C:/Users/thiba/PycharmProjects/mission_IA_JCS/files/images/_DSC0042/_DSC0042.JPG")
...
def plot_mask_with_color(image_path: Path, mask_path: Path) -> None:
    ...
    assert image_name == mask_path.parts[-3], f"The mask {mask_path} doesn't match with the image {image_path}"
